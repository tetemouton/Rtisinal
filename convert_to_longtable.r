convert_to_longtable <- function(flpath=paste0(dirpth, "/Plots/Mean_Wt_tab.tex"), alignmt="llllcc", captn="Blah blah", lbl="tab:tab1"){
  ...
  dat[grep("begin\\{tabular", dat)] <- paste0("\\caption{", captn,"} \\label{", lbl, "}\\\\")
